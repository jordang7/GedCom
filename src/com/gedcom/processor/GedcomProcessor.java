...
public class GedcomProcessor {
    ...
    public IndiFamilyResponse createIndiAndFamilyList(List<String> validLines){
        ...
        return new IndiFamilyResponse(familyArrayList,individualList);
    ...
    public void printFamily(List<Family> familyArrayList) {
        ...
        for (Family family : familyArrayList) {
            System.out.format(" %5s       %30s   %10s               %10s           %5s        %7s       %7s           %7s      ",
                    family.getId(), family.getMarried(), family.getDivorced(), family.getHusbandId(), family.getHusbandId(), family.getWifeId(), family.getWifeName(), family.getChildren());
            System.out.println();
        }
        System.out.println("+---------+--------------------------------+--------------------------+-------------------+--------------------+-----------------+--------------------+--------------------" +
                "+");
